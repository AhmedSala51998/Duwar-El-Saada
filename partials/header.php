...
<style>
  ...
  .loader-text{
    ...
    font-weight:bold;
    text-align:center;
    text-shadow:0 0 6px rgba(255,127,50,0.7);
  ...
  .pulse-dot:nth-child(2){top:12%; right:0; animation-delay:0.1s;}
  .pulse-dot:nth-child(3){bottom:12%; right:0; animation-delay:0.2s;}
  .pulse-dot:nth-child(4){bottom:0; left:50%; animation-delay:0.3s;}
  .pulse-dot:nth-child(5){bottom:12%; left:0; animation-delay:0.4s;}
  .pulse-dot:nth-child(6){top:12%; left:0; animation-delay:0.5s;}
  ...
  .custom-navbar .navbar-brand img{height:55px;width:55px;}
  .custom-navbar .navbar-brand span{font-family:'Scheherazade New', serif;font-size:1.35rem;font-weight:700;}
  ...
  .navbar .nav-link:hover{background:rgba(255,106,0,.08); color:#ff6a00 !important;}
  .navbar .nav-link.active{background:rgba(255,106,0,.15); color:#ff6a00 !important; font-weight:600;}

  .btn-logout{
    background:linear-gradient(135deg,#ff6a00,#ff944d);
    color:#fff;font-weight:600;padding:.5rem 1.2rem;border-radius:50px;
    box-shadow:0 4px 12px rgba(255,106,0,.3);transition:all .3s ease;
  }
  .btn-logout:hover{
  ...
  /* Role badge */
  .role-badge{
    background:#fff3e6;color:#ff6a00;font-weight:600;
  ...
  /* Sidebar */
  .sidebar-link{
    font-weight:500;padding:.5rem .9rem;border-radius:8px;
    display:flex;align-items:center;gap:.4rem;color:#555;transition:all .2s ease;
  }
  .sidebar-link:hover{background:rgba(255,106,0,.08); color:#ff6a00;}
  .sidebar-link.active{background:rgba(255,106,0,.15); color:#ff6a00; font-weight:600;}

  @media (max-width:768px){
    .custom-navbar{padding:.25rem 1rem;}
  }
</style>
</head>
<body class="loading">
...
<script>
  window.addEventListener('load', () => {
    ...
    if(toastEl){const toast = new bootstrap.Toast(toastEl,{delay:2500});toast.show();}
  });
</script>
